...
const fetchUser = async () =>{
    try{
        const res = await axios.get(`http://localhost:3001/api/COmmit/detail_eva/${id_eva}`,{
...
const fetchTopic = async () =>{
    try{
        const res = await axios.get(`http://localhost:3001/api/COmmit/detail_eva/indicate/${id_eva}`,{
            headers:{Authorization:`Bearer ${token}`}
        })
