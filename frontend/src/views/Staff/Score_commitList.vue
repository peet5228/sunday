<template>
    <v-container fluid class="py-10">
                <h1 class="text-h5 text-center font-weight-bold text-maroon">ผลสรุปการประเมินของกรรมการประเมิน</h1>
                <v-card class="pa-4">
...
const fetch = async () => {
    try{
        const res = await axios.get(`${api}/List`,{headers: {Authorization : `Bearer ${token}`}})
