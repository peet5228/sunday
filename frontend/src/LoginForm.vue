                ...
                <v-card color="#7d0c14" elevation="10" rounded="lg">
                    ...
                    <v-container class="bg-white">
                        ...
                        <v-form @submit.prevent="Login">
                            ...
                            <v-select v-model="role" :items="t" label="ประเภทสมาชิก" prepend-inner-icon="mdi-account-group" />
                            <v-btn class="w-full text-white" color="#7d0c14" type="submit">เข้าสู่ระบบ</v-btn>
                        </v-form>
...
const password = ref('')
const role = ref('')
const t = ['ฝ่ายบุคลากร','กรรมการประเมิน','ผู้รับการประเมินผล']
